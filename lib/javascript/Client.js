...
function kb_staging_exporter(url, auth, auth_cb, timeout, async_job_check_time_ms, service_version) {
    var self = this;
    ...
    var _auth_cb = auth_cb;
     ...
     this.export_to_staging = function (params, _callback, _errorCallback) {
        ...
        return json_call_ajax(_url, "kb_staging_exporter.export_to_staging",
    ...
    this.status = function (_callback, _errorCallback) {
        ...
        return json_call_ajax(_url, "kb_staging_exporter.status",
